...
<head>
  <meta charset="utf-8">
    ...
    <title>Minimal-Art Admin - Log in </title>
    ...
    <form action="" method="post" class="form-element">
      ...
      <div class="row">
        ...
        <div class="col-12 text-center">
          <button type="submit"  name="submit" class="btn btn-orange btn-block btn-flat margin-top-10">SIGN IN</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- Mirrored from minimal-art-admin-templates.multipurposethemes.com/pages/examples/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Sep 2018 07:23:57 GMT -->
</html>
